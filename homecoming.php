...
<head>
  ...
  <style type="text/css">
   .img{
	   background-image:url(img/homecomingc/compressed homecoming_poster.webp);
			...
			<div class="container">
				<div class="row d-flex justify-content-center">
					<div class="col-md-10 col-12 trailer" style="padding-top:3.5rem; padding-bottom:15rem;">
						...
						<div class="third">
							<img src="img/homecomingc/compressed homecoming/group2.webp" class="img-2 x">
	...
	<div style="padding:0 2rem;">
		...
		<div class="col-md-3 d-flex justify-content-center" style="padding:0 0rem;">
			...
			<div class="col-md-8 x">
					...
					<img src="img/homecomingc/compressed homecoming/netaji2.webp" class="img-fluid image__img">
				...
				<div class="col-md-4 x align-items-center">
					...
					<img  src="img/homecomingc/compressed homecoming/award1.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary">
							<div class="image__title"></div>
							<p class="image__description"></p>	
				</div></div>
				<div class="image pt-3">
					<img  src="img/homecomingc/compressed homecoming/award2.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary">
							<div class="image__title"></div>
							<p class="image__description"></p>	
				</div></div>					</div>
		...
		<div class="row">
			...
			<div class="col-md-3 x pr-0 pt-2">			
				<div class="image pt-3 pb-3">
					<img  src="img/homecomingc/compressed homecoming/gala2.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary text-center">
							<div class="image__title">Gala Dinner</div>
							<p class="image__description"></p>	
				</div></div>
					<div class="image pt-3 pb-3">
					<img  src="img/homecomingc/compressed homecoming/gala4.webp" class="img-fluid image__img"><div class="image__overlay image__overlay--primary">
							<div class="image__title">Gala Dinner</div>
							<p class="image__description"></p>	
				</div></div>			
			</div>
			<div class="col-md-9 x pl-1">
				<div class="image">
					<img  src="img/homecomingc/compressed homecoming/collage_homecoming.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary text-center">
	...
	<div style="padding:0 3rem;">
		<div class="row">
			...
			<div class="col-md-4 x align-items-center">
				...
				<div class="image">
					<img  src="img/homecomingc/compressed homecoming/group1.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary text-center">
				...
				<div class="image pt-3">
					...
					<img  src="img/homecomingc/compressed homecoming/campus_tour.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary text-center">
							<div class="image__title">Campus Tour</div>
			...
			<div class="col-md-8 x">
				<div class="image">
					<img src="img/homecomingc/compressed homecoming/group2.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary text-center">
							<div class="image__title">Campus Tour</div>
	...
	<div style="padding:0 3rem;">
		<div class="row">
			...
			<div class="col-md-6 x align-items-center">
					<div class="image">
					<img  src="img/homecomingc/compressed homecoming/dept4.webp" class="img-fluid image__img">
				      <div class="image__overlay image__overlay--primary text-center">
			...
			<div class="col-md-6 x">
									<div class="image">
					<img  src="img/homecomingc/compressed homecoming/dept.webp" class="img-fluid image__img">
				      <div class="image__overlay image__overlay--primary text-center">	
				</div></div>
			</div>
			<div class="col-md-6 x">
									<div class="image pt-3">
					<img  src="img/homecomingc/compressed homecoming/dept5.webp" class="img-fluid image__img">
				      <div class="image__overlay image__overlay--primary text-center">	
				</div></div>
			</div>
			<div class="col-md-6 x">
									<div class="image pt-3">
					<img  src="img/homecomingc/compressed homecoming/dept2.webp" class="img-fluid image__img">
				      <div class="image__overlay image__overlay--primary text-center">	
				</div></div>
			</div>
			</div>
  ...
  <section class="section-3 pt-3 pb-5">
	...
	<div style="padding:0 3rem;">
		<div class="row">
			...
			<div class="col-md-8 x">
					<div class="image">
					<img src="img/homecomingc/compressed homecoming/lantern2.webp" class="img-fluid image__img">
					<div class="image__overlay image__overlay--primary text-center">
