...
if (!isset($_SESSION['accom_rzp_order'])) {
    header("Location: accom_payment.php");
    exit;
}

$data = $_SESSION['accom_rzp_order'];
...
<head>
<meta charset="UTF-8">
<title>Secure Payment | Accommodation | Annual Alumni Meet</title>
...
<div class="payment-card">
    ...
    <div class="header">
        ...
        <p>Guest House Payment<br>Accommodation Payment</p>
    </div>
    ...
    <div class="content">
        ...
        <form method="POST" action="https://api.razorpay.com/v1/checkout/embedded">
            ...
            <input type="hidden" name="callback_url" value="https://sac.iitkgp.ac.in/aam22_portal/gh_payment/response.php">
            <input type="hidden" name="cancel_url" value="https://sac.iitkgp.ac.in/aam22_portal/gh_payment/cancel.php">
