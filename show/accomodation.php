    ...
    <ul>
      <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
        <div class="d-flex flex-column" style="width:70%">
          ...
          <div class = "row"><div class = "col-lg-6 col-sm-12 col-md-6"><span class="mb-2 text-sm">Accompanying Kid(s)  </span></div><div class = "col-lg-6 col-sm-12 col-md-6"><span class="text-dark text-sm font-weight-bold"><?php echo "$acc_kid"?>  </span></div></div>
          <div class = "row"><div class = "col-lg-6 col-sm-12 col-md-6"><span class="mb-2 text-sm">Total Attendee(s)  </span></div><div class = "col-lg-6 col-sm-12 col-md-6"><span class="text-dark text-sm font-weight-bold"><?php echo "$acc_tot"?>  </span></div></div>
