    ...
    <ul>
      <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
        <div class="d-flex flex-column" style="width:70%">
          <div class = "row"><div class = "col-lg-6 col-sm-12 col-md-6"><span class="mb-2 text-sm">Resident of IIT Kharagpur</span></div><div class = "col-lg-6 col-sm-12 col-md-6"><span class="text-dark text-sm font-weight-bold"><?php echo "$name"?>     </span></div></div>
          <div class = "row"><div class = "col-lg-6 col-sm-12 col-md-6"><span class="mb-2 text-sm">Employee ID </span></div><div class = "col-lg-6 col-sm-12 col-md-6"><span class="text-dark text-sm font-weight-bold"><?php echo "$email"?>    </span></div></div>
