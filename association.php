...
<?php include 'navbar.php';?>
  ...
  <h2 style="text-align:center">Co Sponsors</h2>
    ...
    <div class="col-md-3"><a href="http://www.tata.com/" target="_blank" >
      ...
      <div class="col-md-3"><a href="http://www.totalenvironment.in/" target="_blank" >
  ...
  <div class="row">
     <br> <br> 
    <h2 style="text-align:center;">Strategic Sponsor</h2>
     <div class=""><br><a href="http://www.maxlifeinsurance.com/"  target="_blank" >
  ...
  <h2 style="text-align:center;">Driven By</h2>
  <div class="row">
    <div class="col-md-3"></div>
     <div class="col-md-3"><a href="http://www.jaguar.in/index.html" target="_blank" ><br><br>
        <img class="spons" src="img/spons/sponsors16/e.jpg" width="200" height="100" />
      </a>
      </div>
      <div class="col-md-3"><a href="http://www.landrover.in/index.html" target="_blank" ><br><br>
  ...
  <div class="row"><div class="col-md-2"></div>
    ...
    <div class="col-md-2"><a href="http://www.isaimpex.in/" target="_blank" >
        <img class="spons"  src="img/spons/sponsors16/d.jpg" width="200" height="170" />
      </a>
      </div>

    <div class="col-md-4"><a href="http://www.tessolve.com/" target="_blank" ><br><br>
        <img class="spons" src="img/spons/sponsors16/n.jpg" width="350" height="100" />
      </a>
      </div>      
       <div class="col-md-2"><a href="http://www.airtel.in/" target="_blank" ><br>
        <img class="spons"   src="img/spons/sponsors16/pics/airtel.jpg" width="170" height="120" />
      </a>
      </div>
      
  </div><br/><br/>
  <h2 style="center">  Outdoor Gear Partner  </h2>    
  <div class="row">
      

      <div class=""><a href="http://wildcraft.in/" target="_blank" >
  ...
  <div class="row"><div class="col-md-2"></div>
      <div class="col-md-2"><a href="http://www.bittuchanachur.com" target="_blank" ><br>
    ...
    <div class="col-md-2"><a href="http://krishproducts.com/" target="_blank" >
        <img class="spons"  src="img/spons/sponsors16/j.jpg" width="120" height="90" />
      </a>
      </div>
  ...
  <div class="row">
    <div class="col-md-2"></div>
      <div class="col-md-2"><a href="http://www.motaramnamkeen.com/" target="_blank" ><br>
        ...
        <div class="col-md-4"><a href="http://www.siegsms.com/" target="_blank" >
        <img class="spons"  src="img/spons/sponsors16/l.jpg" width="200" height="100" />
      </a>
      </div>

      <div class="col-md-2"><a href="https://mobtexting.com/"  target="_blank"><br><br>
  ...
  <br><br/>
  <div class="row"><div class="col-md-2"></div>
     <div class="col-md-2">  <a href="" target="_blank">
         <img class="spons"    src="img/spons/sponsors16/pics/bee.jpg" width="190" height="120" />
      </a>
      </div>
      
       <div class="col-md-4">
      <p style="font-size:20px">Chocolate Gift</p>
      <a href="http://www.chocolatevenue.com/" target="_blank">
         <img class="spons" style="position:relative;top:-20px;" src="img/spons/sponsors16/pics/Co.png" width="190" height="120" />
      </a>
      
    </div>

       <div class="col-md-2">
       <p style="position:relative;font-size:20px">Online Shopping Partner</p>
       <a href="http://rozaanashopping.com/" target="_blank"><br><br>
        <img class="spons"  style="position:relative;top:-40px;" src="img/spons/sponsors16/pics/r.png" width="190" height="80" />
      </a>
      </div>
  ...
  <br><br>
   <div class="row">
    ...
    <div class="col-md-3">
        ...
        <a href="http://www.trustedstay.com/" target="_blank">
  ...
  <br><br>
   ...
   <h2 class="spons_head" style="text-align:center;" >Online Media Partner</h2>
   <div class="row">
