						...
						<div class="container">
							<div class="row d-flex justify-content-center">
								<div class="col-md-4 x align-items-center">
									...
									<div class="image ">
										<img src="img/aam21/inaug/inaug01.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary text-center">
										</div>
									</div>
									<div class="image pt-3">
										<img src="img/aam21/inaug/inaug04.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary text-center">
								...
								<div class="col-md-8 x">
									<div class="image">
										<img src="img/aam21/inaug/inaug03.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary text-center">
					...
					<div class="col-md-9">
						<div class="container">
							<div class="row d-flex justify-content-center">
								<div class="col-md-4 x align-items-center">
									<div class="image">
										<img src="img/aam21/deptvisit/dept01.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary text-center">
										</div>
									</div>
									<div class="image pt-3">
										<img src="img/aam21/deptvisit/dept04.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary text-center">
										</div>
									</div>
								...
								<div class="col-md-8 x">
									<div class="image">
										<img src="img/aam21/deptvisit/dept03.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary text-center">
                    ...
                    <div class="col-md-9">
                        <div class="container">
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-8 x">
                                    <div class="image">
                                        <img src="img/aam21/hallvisit/hall03.webp" class="img-fluid image__img">
                                        <div class="image__overlay image__overlay--primary text-center">
                                ...
                                <div class="col-md-4 x align-items-center">
                                    <div class="image">
                                        <img src="img/aam21/hallvisit/hall02.webp" class="img-fluid image__img">
                                        <div class="image__overlay image__overlay--primary text-center">
                                        </div>
                                    </div>
                                    <div class="image pt-3">
                                        <img src="img/aam21/hallvisit/hall05.webp" class="img-fluid image__img">
                                        <div class="image__overlay image__overlay--primary text-center">
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="container">
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-4 x align-items-center">
                                    <div class="image">
                                        <img src="img/aam21/campus/campus01.webp" class="img-fluid image__img">
                                        <div class="image__overlay image__overlay--primary text-center">
                                        </div>
                                    </div>
                                    <div class="image pt-3">
                                        <img src="img/aam21/campus/campus03.webp" class="img-fluid image__img">
                                        <div class="image__overlay image__overlay--primary text-center">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-8 x">
                                    <div class="image">
                                        <img src="img/aam21/campus/campus05.webp" class="img-fluid image__img">
                                        <div class="image__overlay image__overlay--primary text-center">
							...
							<div class="row d-flex justify-content-center">
								...
								<div class="col-md-6 content-overlay x">
									<div class="image">
										...
										<img src="img/aam21/illu/illu02.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary text-center">
											<div class="image__title">Illumination</div>
					...
					<div class="col-md-9">
						<div class="container">
							<div class="row d-flex justify-content-center">
								<div class="col-md-6 content-overlay x">
									<div class="image">
										<img src="img/aam21/2.2/marathon01.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary">
										</div>
									</div>
								</div>
					...
					<div class="image__overlay image__overlay--primary">
						...
						<div class="container">
							<div class="row d-flex justify-content-center">
								<div class="col-md-6 content-overlay x">
									<div class="image">
										<img src="img/aam21/2.2/marathon03.webp" class="img-fluid image__img">
										<div class="image__overlay image__overlay--primary">
										</div>
									</div>
								</div>
