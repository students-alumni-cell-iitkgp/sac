<div class="section1">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="city" id="personal_city" value = "<?php echo "$city"?>" required />
    </div>
    <div class="form-group">
        <label for="passwordRepeat">State</label>
        <input class="form-control" type="text" name="state" id="personal_state" value = "<?php echo "$state"?>"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="zipcode" id="zipcode" value = "<?php echo "$zipcode"?>"/>
    </div>
    <div class="form-group">
