...
<tr>
    ...
    <td>
        ...
        <a onclick="return confirm('Are you sure you want to delete?')" href="delete.php?id=<?php echo $value['id']; ?>" class="btn btn-danger btn-md" style="text-decoration:none;">delete</a>   -->
