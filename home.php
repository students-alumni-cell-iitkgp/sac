...
<body>
  ...
  <body>
    ...
    <div class="col l5 m12 s12" id="profilepic">
      <div class="card-panel teal lighten-5 " style="width: 100%;text-align: 40px;">
        <div class="container">
          <h3 style="width: 100%; text-align: center;" >Picture for Alumni Card</h3>
          <p>
            Alumni Card is officially distributed to all alumni during the Annual Alumni Meet.
            Kindly upload a picture below to be printed in your Alumni Card (preferably a passport size photograph, image size should be less than 100 Kb and of jpg,jpeg and png format)
          </p>
          <?php 
