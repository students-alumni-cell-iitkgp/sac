...
<body>
  ...
  <div class="container-fluid" style="padding-left: 50px;padding-right: 50px;">
    ...
    <div class="row">
      ...
      <div class="card-panel teal lighten-5 " style="width: 100%;text-align: 40px;">
        <div class="container">
          <h3 style="width: 100%; text-align: center;" >Picture of Alumni Card</h3>
          <p>
            Alumni Card is officially distributed to all alumni during the Annual Alumni Meet.
            Kindly upload a picture below to be printed in your Alumni Card (preferably a passport size photograph, file size should be less than 100Kb)
          </p>
          <?php 
