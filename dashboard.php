                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="bord" style="width:103%;padding-bottom:10px;margin-left:-10px;">
                            <div class="bttons"> <button class=" my-1" id="personal" onclick="personal()"><i
                                        class="fas fa-user d"></i> PERSONAL INFO</button> </div>
                            <div class="bttons"> <button class=" my-1" id="work" onclick="work()"><i
                                        class="fas fa-briefcase d"></i> WORK EXPERIENCE</button> </div>
                            <div class="bttons"> <button class=" my-1" id="nostalg" onclick="nostalg()"><i
                                        class="fas fa-hand-peace d"></i> NOSTALGIC SECTION</button> </div>
                            <div class="bttons"> <button class=" my-1" id="covid" onclick="covid()"><i
                                        class="fas fa-syringe d"></i> COVID INFO</button> </div>
                            <div class="bttons"> <button class=" my-1" id="accomod" onclick="accomod()"><i
                                        class="fas fa-home d"></i> ACCOMMODATION</button> </div>
                            ...
                            <div class="payment-status bttons my-1">
                                ...
                                <span>PAYMENT STATUS:
                                    <?php if(empty($reciept)) echo "<span style='color:red;'>PENDING</span>"; else echo "<span style='color:green;'>PAID</span>" ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-8">
                        ...
                        <!-- <div class="prof6 col">
                            <p align="center">Kharagpur Station
                            <p>
                                <hr />
                            <table class="table table-striped">
                                <tbody>
                            ...
                            <br>
                            <p align="center">Kolkata Airport
                            <p>
                                <hr />
                            <table class="table table-striped">
                                <tbody>
                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button class="btn btn-floating  collapsed" type="button" data-toggle="collapse"
                            ...
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button class="btn  collapsed" type="button" data-toggle="collapse"
                                        ...
                                        Details<?php $status = (empty($kgptimetocome))? ":<span style='color: red'> Pending</span>":NULL; echo $status; ?>
                                    </button>
                                </h2>
                            </div>
