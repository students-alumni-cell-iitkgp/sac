...
<footer class="page-footer black">
    <div class="row">
      <div class="col m10 l4">
                ...
                <p class="grey-text text-lighten-4 text_align" id="address" style="padding-left: 1em">Office of Alumni Affairs & Branding,<br>
                   Indian Institute of Technology, Kharagpur<br>
                    Pin-721302, West Bengal, India<br>
                    Ph: 03222-281860 <br>
                    Email: aao@hijli.iitkgp.ac.in</p>
            </div>
        ...
        <div class="col m10 l4">
          <p id="heading" color="white">Get social with us</p>
        </div>
        <div id="social_icons" class="col l4 m6 ac-soc">
            <ul id="social_icon" class="soc">
               <li style="color: white;" id="connect-template">Get social with us</li> <br>
