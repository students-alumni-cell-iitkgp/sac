          ...
          <div class="center-align" >
              <div class="col l12" style="background-color: white">
                  <div class="info z-depth-2">
                      <p class="text_align" style="padding: 2px 200px">
...
<br><br>
Student Alumni Meets facilitate the implementation of various initiatives of SAC like Mentorship, guest lectures and many others. Further, a platform for the introduction as well as the implementation of many more future initiatives is provided by SAM.Further, SAMs connect the alumni and the students at a very personal level and ensure further interaction and strong bonding. Thus, they prove to be extremely beneficial to the students as well as the alumni. Student Alumni Meets will continue to play a very important role in the functioning of Students&#8217; Alumni Cell. </p>
                  </div>
              </div>
          </div>
      </div>
