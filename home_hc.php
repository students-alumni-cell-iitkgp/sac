...
<body>
  ...
  <body>
    ...
    <div class="container-fluid" style="padding-left: 50px;padding-right: 50px;">
      <p class="center">
        We will be showing you important information regarding the meet here. Check back in a few days to find out more about Homecoming.
      </p>
      <div class="row">
        <div class="col l7">
          <div class="container-fluid">
            <div class="container" style="width: 100%">
              <div class="card-panel teal lighten-5">
                ...
                to be made. For professors based in IIT Kharagpur, the amount is INR 3500, with an addditional payment of INR 2000 per head for each accompanying guest.
                <br>
                <br>
                ...
                <ul class="">
                  ...
                  <li class="">
                    ...
                    <br> You can pay by sending a cheque or demand draft (DD) if favour of "Homecoming" payable at Kharagpur on the address:
