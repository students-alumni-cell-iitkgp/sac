...
<div class="row">
  <div class="col s12 m7">
    ...
    if(empty($row['url']))
    {
      echo '<a class="btn-floating halfway-fab waves-effect waves-light red btn modal-trigger" href="#modal_pic"><i class="material-icons right>add</i></a>';
    }
    else
    {

      echo '<a class="btn-floating halfway-fab waves-effect waves-light red btn modal-trigger right" href="#modal_pic"><i class="material-icons right">edit</i></a>';
    }
